...
var $author$project$Domain$Achievement$Utils$applyUnlocks = F2(
	function (unlocked, model) {
		var newAchievements = A2(
			$elm$core$List$map,
			function (ach) {
...
var $author$project$View$globalStyles = A3(
	$elm$html$Html$node,
	'style',
	_List_Nil,
	_List_fromArray(
...
var $author$project$Domain$Achievement$Utils$groupAchievements = function (achievements) {
	...
	return $elm$core$Dict$toList(
		A3($elm$core$List$foldl, insert, $elm$core$Dict$empty, achievements));
};
...
var $author$project$UI$StatBox$statBox = F2(
...
var $author$project$Domain$Achievement$View$tooltipStyle = function (isVisible) {
	return _List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
			A2($elm$html$Html$Attributes$style, 'top', '110%'),
			A2($elm$html$Html$Attributes$style, 'left', '50%'),
			A2(
			$elm$html$Html$Attributes$style,
			'transform',
			isVisible ? 'translateX(-50%) translateY(0)' : 'translateX(-50%) translateY(-4px)'),
			A2(
			$elm$html$Html$Attributes$style,
			'opacity',
			isVisible ? '1' : '0'),
			A2($elm$html$Html$Attributes$style, 'transition', 'opacity 120ms ease-out, transform 120ms ease-out'),
			A2($elm$html$Html$Attributes$style, 'background', '#222'),
...
var $author$project$Domain$Achievement$View$tooltipView = F2(
	function (isHovered, ach) {
		return A2(
			$elm$html$Html$div,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src('https://placehold.co/200x200/8B4513/FFF?text=Yay!'),
...
var $author$project$Domain$Achievement$View$viewAchievement = F2(
	function (model, ach) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Domain$Achievement$View$trophyIcon(ach),
					A2($author$project$Domain$Achievement$View$tooltipView, isHovered, ach)
				]));
	});
var $author$project$View$viewColumn = F2(
	function (achievementModel, _v0) {
		var categoryName = _v0.a;
		var achievements = _v0.b;
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			A2(
				$elm$core$List$map,
				$author$project$Domain$Achievement$View$viewAchievement(achievementModel),
				achievements));
	});
var $author$project$View$leftPanelView = F2(
	function (storeModel, achievementModel) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Events$onClick($author$project$Msg$Clickpoop),
							$elm$html$Html$Attributes$alt('Giant poop'),
...
var $author$project$Domain$Notification$View$maybeViewNotification = function (notification) {
	if (!notification.$) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('notification-toast'),
					A2($elm$html$Html$Attributes$style, 'background', '#f59e0b'),
					A2($elm$html$Html$Attributes$style, 'color', '#0b1220'),
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('notification-toast'),
					A2($elm$html$Html$Attributes$style, 'background', '#0b1220'),
					A2($elm$html$Html$Attributes$style, 'color', '#0b1220'),
					A2($elm$html$Html$Attributes$style, 'padding', '16px 24px'),
					A2($elm$html$Html$Attributes$style, 'border-radius', '8px'),
					A2($elm$html$Html$Attributes$style, 'font-weight', 'bold'),
...
var $author$project$View$rightPanelView = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'margin', '0'),
						A2($elm$html$Html$Attributes$style, 'font-size', '20px'),
						A2($elm$html$Html$Attributes$style, 'border-bottom', '1px solid rgba(255,255,255,0.1)'),
...
var $author$project$View$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$View$globalStyles,
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('grid-layout')
							]),
						_List_fromArray(
							[
